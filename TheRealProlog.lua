...
function love.load()
  ...
  knight = {}
  knight.img = love.graphics.newImage('KnightProlog2.png')
  knight.imgQuad = Quad(0, 0, 300, 350, 300, 600)
  knight.x = -280
  knight.y = 130
  knight.speak = false
  dragon = {}
  dragon.img = love.graphics.newImage('DragonProlog.png')
  ...
  dragon.speak = false
  stranger = {}
  stranger.img = love.graphics.newImage('MageProlog.png')
  stranger.need = true
  stranger.x = 2000
  stranger.y = 50
